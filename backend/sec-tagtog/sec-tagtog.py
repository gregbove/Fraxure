...
class SECTagTog:
    ...
    def mostRecent(self, form_type, company_tick):
        ...
        self.tagtog.import_by_html("TestProject", self.dir+ "/" + company_tick + "_" + form_type + ".html")
...
def main():
    test_api = SECTagTog('ryanmurf9', 'testapipassword123', "/home/ryanmurf9/Documents/Senior Project/Fraxure/backend/sec-tagtog/file_system", "TestProject")
